...
pl_repo <- ggplot(s5_annt, aes(x=Year)) +
            labs(list(title = "Repurchases and Net Repurchases (2006-2015)", y = "Billions", x = "")) + 
...
pl_div <- ggplot(s5_annt, aes(x=Year)) +
            labs(list(title = "Dividends and Net Income (2006-2015)", y = "Billions", x = "")) + 
...
pl_pay <- ggplot(s5_annt, aes(x=Year)) +
            labs(list(title = "Payouts and Net Payouts (2006-2015)", y = "Billions", x = "")) + 
